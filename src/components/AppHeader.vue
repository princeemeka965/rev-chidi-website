...
<template>
  <header 
    class="fixed top-0 left-0 right-0 z-50 w-full backdrop-blur-md transition-all duration-300 border-b"
    :class="{
  ...
  >
    ...
    :class="isScrolled ? 'py-3' : ''">
      <router-link 
        ...
        @click="closeAllMenus"
      >
        <img src="https://res.cloudinary.com/campnet/image/upload/v1754573457/ChatGPT_Image_Aug_7_2025_02_25_38_PM_kiptse.png" class="w-7 h-7 rounded-full sm:w-8 sm:h-8 text-blue-600" />
      ...
      <div class="flex items-center gap-2">
        ...
        <button 
          ...
          class="md:hidden p-2 rounded-lg hover:bg-gray-100 transition-colors z-50"
    ...
    >
      ...
      >
        ...
        >
          <div 
            v-show="isMobileMenuOpen"
            class="relative bg-white h-full w-full pt-10 max-w-sm overflow-y-auto shadow-xl"
            @click.stop
          >
